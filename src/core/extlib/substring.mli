...
val base : t -> string * int * int
  (** [base sus] is the concrete triple (s, i, n), where sus = (s, i,
      n). *)

val is_empty : t -> bool
  (** [isEmpty (s, i, n)] true if the substring is empty (that is, n =
      0). *)
...
(**
   ...
   contains the rest.  Raises Invalid_argument if k < 0 or k > size sus.
*)
