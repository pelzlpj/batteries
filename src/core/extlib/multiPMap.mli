...
val iter : ('a -> 'b PSet.t-> unit) -> ('a, 'b) t -> unit
...
val map : ('b PSet.t -> 'c PSet.t) -> (('b -> 'b -> int) -> ('c -> 'c -> int)) -> ('a, 'b) t -> ('a, 'c) t
...
val mapi : ('a -> 'b PSet.t -> 'c PSet.t) -> (('b -> 'b -> int) -> ('c -> 'c -> int)) -> ('a, 'b) t -> ('a, 'c) t
(** Same as [map], but the function receives as arguments both the
    key and the associated value for each binding of the map. *)

val fold : ('b PSet.t -> 'c -> 'c) -> ('a , 'b) t -> 'c -> 'c
...
val foldi : ('a -> 'b PSet.t -> 'c -> 'c) -> ('a , 'b) t -> 'c -> 'c
...
val print : ?first:string -> ?last:string -> ?sep:string -> 
  (('a #InnerIO.output as 'out) -> 'b -> unit) -> ('out -> 'c -> unit) -> 'out -> ('b, 'c) t -> unit
